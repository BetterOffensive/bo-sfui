...
//##protect##"instance$methods"
    ...
    public:
        ...
        enum MethodID {
            ...
            mid_extraAudioTrackGet, 
            mid_extraAudioTrackSet, 
            mid_voiceTrackGet, 
            mid_voiceTrackSet, 
            ...
            mid_extraSoundTransformGet, 
            mid_extraSoundTransformSet, 
            mid_reloadThresholdTimeSet, 
            mid_numberOfFramePoolsSet, 
            mid_openTimeoutSet, 
        };
        virtual void AS3Constructor(unsigned argc, Value* argv);
        ...
        void play(Value& result, unsigned argc, Value* const argv);
        ...
        void send(Value& result, unsigned argc, Value* const argv);
        ...
        void extraAudioTrackGet(Value::Number& result);
        void extraAudioTrackSet(const Value& result, Value::Number track);
        ...
        void extraSoundTransformGet(SPtr<Instances::fl_media::SoundTransform>& result);
        void extraSoundTransformSet(const Value& result, Instances::fl_media::SoundTransform* value);
        ...
        Value::Number extraAudioTrackGet()
        {
            Value::Number result;
            extraAudioTrackGet(result);
            return result;
        }
        void extraAudioTrackSet(Value::Number track)
        {
            extraAudioTrackSet(Value::GetUndefined(), track);
        }
        ...
        SPtr<Instances::fl_media::SoundTransform> extraSoundTransformGet();
        void extraSoundTransformSet(Instances::fl_media::SoundTransform* value)
        {
            extraSoundTransformSet(Value::GetUndefined(), value);
        }
...
namespace InstanceTraits { namespace fl_net
{
    ...
    public: 
        ...
        enum { ThunkInfoNum = 49 };
        static const ThunkInfo tim[ThunkInfoNum];
        // static const UInt16 tito[ThunkInfoNum];
        static const TypeInfo* tit[78];
